...
<DiagramContainer title="Workflow PR с CI">
  <SequenceDiagram>
    <Actor name="DE" />
    <Actor name="GitHub" />
    <Actor name="CI runner" />
    <Actor name="Reviewer" />
    <Lifeline />
    <Message from="DE" to="GitHub" label="git push origin feat/new-dag" />
    <Message from="GitHub" to="GitHub" label="git push triggers PR creation" />
    <Message from="GitHub" to="CI runner" label="trigger workflow (.github/workflows/ci.yml)" />
    <Message from="CI runner" to="CI runner" label="checkout, install, lint, test, build" />
    <Message from="CI runner" to="GitHub" label="status: success / failure" />
    <Message from="GitHub" to="DE" label="UI: check passed / failed" />
    <Message from="Reviewer" to="GitHub" label="reviews code (если CI зелёный)" />
    <Message from="Reviewer" to="GitHub" label="approve + merge" />
  </SequenceDiagram>
</DiagramContainer>
